...
import { completeTeacherQuestion } from "@/lib/services/assignmentService";
...
export async function POST(req: NextRequest, ctx: Ctx) {
  try {
    ...
    const body = (await req.json()) as CompleteQuestionBody;
    const question = await completeTeacherQuestion(
      auth.sub,
